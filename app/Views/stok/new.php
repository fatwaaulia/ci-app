                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select <?= $val->hasError('id_barang') ? "is-invalid" : '' ?>" name="id_barang" id="select_box1">
                                            <option value="" <?= (!old('id_barang')) ? 'selected' : '' ?>>pilih barang</option>
                                    ...
                                    <div class="mb-3">
                                        <label for="id_supplier" class="form-label">Supplier</label><span class="text-danger">*</span>
                                        <select class="form-select <?= $val->hasError('id_supplier') ? "is-invalid" : '' ?>" name="id_supplier[]" multiple id="select_box2">
                                            <option value="" <?= (!old('id_supplier')) ? 'selected' : '' ?>>pilih supplier</option>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control <?= $val->hasError('stok') ? "is-invalid" : '' ?>" name="stok" value="<?= old('stok') ?>" id="stok" placeholder="masukkan stok">
                                        <div class="invalid-feedback">
                                            <?= $val->getError('stok') ?>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select <?= $val->hasError('satuan') ? "is-invalid" : '' ?>" name="satuan" id="satuan" aria-label="Default select example">
                                            <option value="" <?= (!old('id_supplier')) ? 'selected' : '' ?>>pilih satuan</option>
