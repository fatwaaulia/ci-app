            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="<?= base_url() . '/supplier/new' ?>">
                            <button type="button" class="btn btn-primary btn-sm mb-3">Tambah</button>
                        </a>

                        <table id="supplierTb" class="table table-striped" style="width:100%">
                            <thead>
                                <tr>
                                    <th>No.</th>
                                    <th>Kode Supplier</th>
                            ...
                            <tbody>
                                <?php foreach ($supplier as $key => $row) { ?>
                                    <tr>
                                        ...
                                        <td><?= $row['alamat'] ?></td>
                                        <td>
                                            <a href="<?= base_url() . '/supplier/edit/' . model('SupplierModel')->encId($row['id']) ?>">
                                            ...
                                            <div class="modal fade" id="delete<?= $row['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="<?= base_url() . '/supplier/delete/' . model('SupplierModel')->encId($row['id']) ?>" method="post">
                                                            <div class="modal-body">
                                                                <span><b>Kode Supplier :</b> <?= $row['kode'] ?></span> <br>
                                                                <span><b>Nama Supllier :</b> <?= $row['nama'] ?></span> <br>
                                                            </div>
