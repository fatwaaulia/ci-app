<section>
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h5><strong>Form</strong> Edit Pengguna</h5>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url() . '/users/update/' . model('UserModel')->encId($user['id']) ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="<?= base_url() . '/UserController/deletePhoto/' . model('UserModel')->encId($user['id']) ?>" class="btn btn-danger btn-sm">Hapus</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control <?= $val->hasError('email') ? "is-invalid" : '' ?>" name="email" value="<?= old('email') ?? $user['email'] ?>" id="Email" placeholder="name@example.com">
                                        <div class="invalid-feedback">
                                            <?= $val->getError('email') ?>
                                        </div>
                                    </div>
